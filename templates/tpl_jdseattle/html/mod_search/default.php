...
<div class="search">
	...
	<div class="input-group">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$btn_output = ' <div class="input-group-prepend"><input type="image" alt="' . $button_text . '" class="button btn btn-dark" src="' . $img . '" onclick="this.form.searchword.focus();"/></div>';
				else :
					$btn_output = ' <div class="input-group-prepend"><button class="button btn btn-dark" onclick="this.form.searchword.focus();">' . $button_text . '</button></div>';
				endif;
