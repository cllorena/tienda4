...
class SmartSlider3Info {
    ...
    public static $version = '3.5.1.5';

    public static $channel = 'stable';

    public static $revision = 'b88c6cc4389729dd72c357b094c7008280a8b48f';

    public static $revisionShort = 'b88c6cc4';

    public static $branch = 'release-3.5.1.5';
