...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2021-07-25' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2021-07-25';
		self::$version_name  = ('Melia' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Melia';
	}
